...
(() => {
  ...
  function setup(){
    ...
    if (sidebar && !sidebar.querySelector('[data-elara-tab="missions"],[data-tab="missions"]')) sidebar.insertBefore(makeNav('✦ مأموریت‌ها','nav-item'), sidebar.querySelector('[data-tab="settings"]'));
