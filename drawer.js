...
(() => {
  ...
  document.addEventListener('click',async e=>{
    ...
    const route=e.target.closest('[data-drawer-route]');if(route){close();window.ElaraOpen?.(route.dataset.drawerRoute);return}
    ...
    const edit=e.target.closest('[data-profile-edit]');if(edit){close();await window.ElaraProfileSystem?.openEditor?.();return}
