...
(() => {
  ...
  for(const name of ['elara-design.css','elara-finishing.css','approved-visual.css','approved-tuning.css','approved-reference-fidelity.css','approved-wellness.css','approved-navigation-extension.css','approved-seasonal.css','approved-home-return.css','approved-language-journal.css','visual-fidelity-pass2.css','visual-fidelity-pass3.css','visual-fidelity-pass4.css','visual-fidelity-pass5.css','reference-home-shell-2026.css','artwork-home-install-2026.css','home-functional-pass-2026.css']){
    const css=document.createElement('link');css.rel='stylesheet';css.href=name;
    if(['reference-home-shell-2026.css','artwork-home-install-2026.css','home-functional-pass-2026.css'].includes(name))critical.push(new Promise(resolve=>{css.onload=resolve;css.onerror=()=>{console.error('Critical Elara CSS missing:',name);resolve(false)}}));
  ...
  const rescue=setTimeout(()=>{console.warn('Elara shell boot timeout; releasing page for recovery.');release()},5000);
  ...
  void (async()=>{
    ...
    }finally{clearTimeout(rescue);release()}
  })();
  const launch=async()=>{
