...
(() => {
  ...
  const criticalImages=(!location.hash||location.hash==='#home')?[
    ...
    'assets/ui/icon-mode-night-active.webp','assets/ui/icon-mode-night-default.webp','assets/ui/icon-notifications-read.webp','assets/ui/icon-notifications-unread.webp','assets/ui/brand-elara-app-mark.webp','assets/ui/icon-wellness-heartbeat.webp','assets/ui/icon-exercise-dumbbell.webp','assets/ui/icon-ranking-trophy.webp','assets/ui/icon-tasks-check-alpha.webp','assets/ui/missions-rocket.webp','assets/ui/streak-flame.webp','assets/ui/friends-tab.webp'
  ]:[];
