/* Canonical Elara navigation: same seven routes, distinct desktop/mobile order. */
(()=>{'use strict';
...
function renderMainNav(root){if(!root)return;root.dataset.elaraNavOwner='canonical';root.replaceChildren(...MAIN.map(def=>button(def,'main')))}
...
window.ElaraNavigation={routes:MAIN,sidebarRoutes:SIDEBAR,desktopOrder:DESKTOP_ORDER,secondaryRoutes:SECONDARY,render,renderMainNav,renderSidebar,active};
